...
import 'entity_novel_book_recommend.dart';
...
class NovelDetailInfo extends Object {
  ...
  NovelBookRecommend novelBookRecommend;


  NovelDetailInfo(this.id, this.title, this.author, this.cover,
      this.totalFollower, this.wordCount, this.tags,this.longIntro);
