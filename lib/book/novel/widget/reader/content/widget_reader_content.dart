...
import 'package:flutter_parse_html/book/novel/widget/reader/content/helper/animation/controller_animation_with_listener_number.dart';
import 'package:flutter_parse_html/book/novel/widget/reader/content/helper/helper_reader_content.dart';
import 'package:flutter_parse_html/book/novel/widget/reader/content/helper/manager_reader_page.dart';
import 'package:flutter_parse_html/book/novel/widget/reader/content/widget_reader_painter.dart';
...
import 'package:flutter_parse_html/book/novel/widget/reader/widget/widget_novel_reader_error.dart';
import 'package:flutter_parse_html/book/novel/widget/reader/widget/widget_novel_reader_loadding.dart';
...
class NovelPageReader extends BaseStatefulView<NovelReaderViewModel> {
  ...
  void startConfirmAnimation(){
    mPainter.startConfirmAnimation();
  }
...
class _NovelPageReaderState
                    ...
                    ..onDown = (detail) {
                      if (true) {
                        if (currentTouchEvent.action !=
                          ...
                          widget.mPainter.setCurrentTouchEvent(currentTouchEvent);
  ...
  void loadData(BuildContext context, NovelReaderViewModel viewModel) {
    ...
    if (animationController != null) {
      ...
      widget.mPainter = NovelPagePainter(pageManager: pageManager);
    }
