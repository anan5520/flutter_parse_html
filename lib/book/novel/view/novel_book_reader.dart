...
import 'package:flutter_parse_html/book/novel/widget/reader/cache/novel_config_manager.dart';
import 'package:flutter_parse_html/book/novel/widget/reader/content/helper/manager_reader_page.dart';
import 'package:flutter_parse_html/book/novel/widget/reader/content/widget_reader_content.dart';
import 'package:flutter_parse_html/book/novel/widget/reader/menu/manager_menu_widget.dart';
import 'package:flutter_parse_html/book/novel/widget/reader/menu/widget_reader_bottom_menu.dart';
import 'package:flutter_parse_html/book/novel/widget/reader/menu/widget_reader_catalog_menu.dart';
import 'package:flutter_parse_html/book/novel/widget/reader/menu/widget_reader_setting_menu.dart';
import 'package:flutter_parse_html/book/novel/widget/reader/menu/widget_reader_top_menu.dart';
import 'package:flutter_parse_html/book/novel/view_model/view_model_novel_reader.dart';
import 'package:flutter_parse_html/book/novel/widget/reader/model/model_reader_config.dart';
...
//    print("ScreenWidth:"+MediaQuery.of(context).size.width.toString());
  ...
  Widget buildView(BuildContext context, NovelReaderViewModel viewModel) {
    ...
    NovelPageReader novelPageReader =  NovelPageReader(readerKey);
    return Scaffold(
      body: SafeArea(
          child: Container(
          ...
          children: <Widget>[
            GestureDetector(
              child: RepaintBoundary(
                child: novelPageReader,
              ),
              onTapUp: (detail){
                if((_tapDownDetails.globalPosition.dy - detail.globalPosition.dy).abs() < 10 &&
                    (_tapDownDetails.globalPosition.dx - detail.globalPosition.dx).abs() < 10){
                  if((detail.globalPosition.dx > ScreenUtils.getScreenWidth()/3 &&
                      detail.globalPosition.dx < ScreenUtils.getScreenWidth() * 2/3)|| _isMenuOpen){
                    toggleMenu((isOpen) {
                      if (!isOpen) {
                    ...
                    novelPageReader.startConfirmAnimation();
                  }
