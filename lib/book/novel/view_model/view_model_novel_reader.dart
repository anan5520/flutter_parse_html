...
import 'package:flutter_parse_html/book/novel/model/zssq/model_book_db.dart';
...
import 'package:flutter_parse_html/book/novel/model/model_novel_cache.dart';
import 'package:flutter_parse_html/book/novel/model/zssq/model_book_net.dart';
import 'package:flutter_parse_html/book/novel/widget/reader/content/helper/helper_reader_content.dart';
import 'package:flutter_parse_html/book/novel/widget/reader/manager/manager_reader_progress.dart';
import 'package:flutter_parse_html/book/novel/widget/reader/model/model_reader_config.dart';
import 'package:flutter_parse_html/book/novel/widget/reader/model/model_reader_content.dart';
...
//    notifyRefresh();
  ...
  void requestNewContent(Chapters chapterData) async {
    ...
    String url = HomePage.inLsj?chapterData.link:chapterData.link.replaceAll('m.tycqxs', 'tycqxs');
    String originalContent =
        await _cacheModel.getCacheChapterContent(url);
  ...
  void requestCatalog(String novelId) async {
    ...
    var result = await _netModel.getNovelBookCatalog(novelId);
...
//    {
//      parsedString = document.getElementsByClassName('read-content j_readContent').first.text;
//    }
