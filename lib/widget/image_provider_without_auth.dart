...
class NetworkImageWithoutAuth extends image_provider.ImageProvider<image_provider.NetworkImage> implements image_provider.NetworkImage {
  ...
  @override
  Future<NetworkImageWithoutAuth> obtainKey(image_provider.ImageConfiguration configuration) {
  ...
  bool operator ==(Object other) {
    if (other.runtimeType != runtimeType)
      return false;
    return other is NetworkImageWithoutAuth
        && other.url == url
        && other.scale == scale;
  }
